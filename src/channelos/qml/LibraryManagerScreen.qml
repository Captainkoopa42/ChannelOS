...
Item {
    ...
    property var browseHost: null
    property bool active: false
    visible: active && hostWindow !== null && hostWindow.screen === "library"
    ...
    Rectangle {
        ...
        Row {
            ...
            Text { text: "ESC  Library"; color: textSecondary; font.pixelSize: 13 }
        }
